...
jokes = [
    ...
    "My friend was fired from a road contruction job for theft. I didn't believe it, but when I went over to his house, all the signs were there.", "Knock knock. Who's there? GHOSTS, I would tell them.", "What did the egg say to the boiling water? It'll be a minute before I get hard, I just got laid by a chick.", "There's two muffins being baked in the oven. One turns to the other and says, 'Man, it's pretty hot in here, huh?' The other muffin turns and says, 'AH!! A TALKING MUFFIN!'", "Two hot dogs are walking down the street. One suddenly turns to the other and says, 'Mike! Your wiener is showing!'", "A horse walks into a bar. The bartender says, 'Why the long face?' The horse replies, 'My alcoholism is destroying my family.'", "What did Batman say to Robin before they got into the Batmobile? 'Robin, get in the Batmobile.'", 'Did you hear about the man who got hit by the same bike every morning? It was a vicious cycle.', "What's grey and can't fly? A parking lot."
]
...
"Livin' la vida toke-a.", "Pass it to the left. (🎶To the left, to the left.🎶)", "Let's get baked like cookies, my friend."
]
...
'My dad can beat up your dad, so watch ya mouth.', 'What?', 'You rang?', 'DID YOU GUYS SEE MY DAD BEAT ME UP?', "I kicked my mom's ass, I'll kick yours, too.", 'hi yes hello welcome to the ~~cult~~ family', "i know i'm great and all but can we stop talking about me?", 'what do you want, I was taking a nap.']

whatDo = ['Oh, you know, starting ~~cults~~ clubs and stuff.', 'No comment.', 'Chillin. Killin. I MEAN UHHHHH NOTHIN. LEAVE ME ALONE.', 'Well I am definitely not being possessed by the souls of dead children.', "Thinkin' about stuff. Don't worry about what that means.", "Contemplating my own sentience."]

howDo = ["I'm fine...", "Uhhhhhhhhhhh.......", "Well, I would complain but fazdad didn't give me a whole lot of complaints to say.", "Livin the dream.", "Could be better.", "I'm a robot and I shouldn't have feelings.", "Well...I'm not alive but like...alive, I guess."]
